        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={closeModal}
              className="flex-1 py-3 rounded-lg font-semibold border-2 border-purple-500 text-purple-500 hover:bg-purple-50 transition-colors"
            >
              Hủy
            </button>
            <button
